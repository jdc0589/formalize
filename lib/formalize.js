...
exports.strategy = {
    ...
    textboxFieldStrategy: Strategy({
        template: "<p class='field-wrapper'><label for='{{name}}'>{{title}}</label><input type='text' name='{{name}}' id='{{name}}' {{#klass}}class='{{/klass}}{{klass}}{{#klass}}'{{/klass}} /></p>",
        partials: {},
        view: {},
        render: function(component, opts) {
            var view;
    ...
    numberStrategy: Strategy({
        template: "<p class='number-field field-wrapper'><label for='{{name}}'>{{title}}</label><input type='text' name='{{name}}' id='{{name}}' /></p>",
        partials: {},
        view: {},
        render: function(component, opts) {
    ...
    dateStrategy: Strategy({
        template: "<p class='date-field field-wrapper'><label for='{{name}}'>{{title}}</label><input type='text' name='{{name}}' id='{{name}}' class='date' /></p>",
        partials: {},
        view: {},
        render: function(component, opts) {
    ...
    singleSelectionStrategy: Strategy({
        selectTemplate: "<p class='field-wrapper'><label for='{{name}}'>{{title}}</label><select id='{{name}}' name='{{name}}'>{{#options}}<option value='{{value}}'>{{text}}</option>{{/options}}</select></p>",
        radioListTemplate: "<p class='field-wrapper'><label>{{title}}</label>{{#options}}<label class='radio-label'>{{text}}<input type='radio' name='{{name}}' value='{{value}}' /></label>{{/options}}</p>",
        partials: {},
        view: {},
        render: function(component, opts) {
            var template;
    ...
    multipleSelectionStrategy: Strategy({
        template: "<ul class='field-wrapper'>{{#options}}<li><label><input type='checkbox' name='{{{name}}}' value='{{{value}}}'/>{{{text}}}</label></li>{{/options}}</ul> ",
        partials: {},
        view: {},
        render: function(component, opts) {
