...
exports.strategy = {
    ...
    groupStrategy: Strategy({
        template: "<div id='{{name}}'>{{#components}}{{{html}}}{{/components}}</div>",
        partials: {},
        view: {},
        render: function(component, opts) {
	...
	decimalStrategy: Strategy({
        template: "<p class='decimal-field'><label for='{{name}}'>{{title}}</label><input type='text' name='{{name}}' id='{{name}}' /></p>",
        partials: {},
        view: {},
        render: function(component, opts) {
    ...
    singleSelectionStrategy: Strategy({
        selectTemplate: "<p><label for='{{name}}'>{{title}}</label><select id='{{name}}' name='{{name}}'>{{#options}}<option value='{{value}}'>{{text}}</option>{{/options}}</select></p>",
        radioListTemplate: "<p><label>{{title}}</label>{{#options}}<label>{{text}}<input type='radio' name='{{name}}' value='{{value}}' /></label>{{/options}}</p>",
        partials: {},
        view: {},
        render: function(component, opts) {
            var template;
    ...
    multipleSelectionStrategy: Strategy({
        template: "<ul>{{#options}}<label><input type='checkbox' name='{{name}}' value='{{value}}' />{{text}}</label>{{/options}}</ul>",
        partials: {},
        view: {},
        render: function(component, opts) {
