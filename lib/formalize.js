...
exports.strategy = {
    ...
    singleSelectionStrategy: Strategy({
        ...
        radioListTemplate: "<p class='field-wrapper'><label>{{title}}</label>{{#options}}<label class='radio-label'>{{text}}<input type='radio' name='{{name}}' value='{{value}}' group='{{name}}'/></label>{{/options}}</p>",
        partials: {},
        view: {},
        render: function(component, opts) {
            var template;
